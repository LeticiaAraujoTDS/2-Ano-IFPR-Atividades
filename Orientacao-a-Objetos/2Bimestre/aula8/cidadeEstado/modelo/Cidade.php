...
class Cidade {
    ...
    {
        return "\nA cidade de " . $this->getNome() . ", localizada no estado " . $this->getEstado()->getNomeEstado() . "-" . $this->getEstado()->getSigla() . ", possui " . $this->getQtdHabitantes() . " habitantes e uma altitude de " . $this->getAltitude() . " metros.";
    }
